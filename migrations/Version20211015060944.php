 ...
 */
final class Version20211015060944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE complaint (id INT AUTO_INCREMENT NOT NULL, post_id_id INT NOT NULL, ip VARCHAR(255) NOT NULL, INDEX IDX_5F2732B5E85F12B8 (post_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
